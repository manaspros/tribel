...
import tribalDecoration from "../assets/TRTI CG english logo curve.jpg";
// Import museum page data
import museumPageData from "../data/museumPageData.json";
...
const TribalMuseumPage = () => {
  ...
  const getContent = (path) => {
    ...
    return content[language] || content["en"] || `No translation for ${path}`;
  };

  const locationAddress = getContent("tribalMuseum.infoCards.address");
  ...
  return (
    <PageContainer>
      ...
      <HeroSection>
        ...
        >
          {getContent("tribalMuseum.heroTitle")}
        </PageTitle>
      </HeroSection>
      ...
      <ContentContainer>
        ...
        >
          <Description>{getContent("tribalMuseum.introduction")}</Description>
          ...
          <InfoGrid>
            ...
            >
              <InfoTitle>
                ...
                {getContent("tribalMuseum.infoCards.locationTitle")}
              </InfoTitle>
              <MapContainer
              ...
              >
                ...
                <MapOverlay isHovered={mapHovered}>
                  {getContent("tribalMuseum.infoCards.viewDirections")}
                </MapOverlay>
              </MapContainer>
              <p
                style={{
          ...
          <SectionTitle>
            {getContent("tribalMuseum.collectionTitle")}
          </SectionTitle>
          <Description>
            {getContent("tribalMuseum.collectionDescription")}
          </Description>

          <SectionTitle>
            {getContent("tribalMuseum.visitingExperienceTitle")}
          </SectionTitle>
          <Description>
            {getContent("tribalMuseum.visitingExperienceDescription")}
          </Description>
          ...
          <LinksSection>
            <StyledLink to="/tribal/gallery">
              <svg
                ...
                fill="currentColor"
              >
                <path d="M4 8h4V4H4v4zm6 12h4v-4h-4v4zm-6 0h4v-4H4v4zm0-6h4v-4H4v4zm6 0h4v-4H4v4zm6-10v4h4V4h-4zm-6 4h4V4h-4v4zm6 6h4v-4H4v4zm0 6h4v-4H4v4z" />
              </svg>
              {getContent("tribalMuseum.buttonLabels.galleries")}
            </StyledLink>
            <StyledLink to="/tribal/artifacts">
              ...
              {getContent("tribalMuseum.buttonLabels.collection")}
            </StyledLink>
            <StyledLink to="/virtual-tour">
              ...
              {getContent("tribalMuseum.buttonLabels.virtualTour")}
            </StyledLink>
          </LinksSection>
        </motion.div>
      </ContentContainer>
